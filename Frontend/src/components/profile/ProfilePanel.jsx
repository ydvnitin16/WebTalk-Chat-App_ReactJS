    ...
    <aside className="w-1/4 bg-white hidden lg:flex flex-col p-4 rounded-4xl mx-1 dark:bg-zinc-900 dark:text-white overflow-y-auto">
      ...
      <div className="flex flex-col items-center text-center">
        <img
          ...
          alt="profile"
        />
        <p className="font-bold text-xl text-gray-800 dark:text-gray-200">{selectedUser.name}</p>
        <p className="text-sm text-gray-500 dark:text-gray-300 my-2">{selectedUser.bio}</p>
      </div>
