  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div className="w-full max-w-sm bg-white/30 backdrop-blur-[6px] dark:bg-[#151515]/30 shadow-inner dark:shadow-zinc-800 shadow-zinc-400 border-zinc-300 rounded-4xl dark:border-zinc-800 p-6 relative">
          <Button
            onClick={onClose}
            variant="outline"
